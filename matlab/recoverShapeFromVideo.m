...
%% INPUT DATA
cplaneVideo = 'cplane_30fps_100ms_10px_1920x1440.avi';
objectVideo = 'object_30fps_100ms_10px_1920x1440.avi';
...
p1 = [232, 457];            % calibration point 1 (x1, y1) <- left eye
p2 = [483, 462];            % calibration point 2 (x2, y2) <- right eye
